...
const DoctorsPage = () => {
  return (
    ...
    <div className=" container d-flex flex-column flex-md-row flex-wrap gap-5  align-items-center justify-content-center  m-auto  pb-5" style={{margin:"80px", cursor:"pointer"}}>
        {doctors.map((doc) =>(
